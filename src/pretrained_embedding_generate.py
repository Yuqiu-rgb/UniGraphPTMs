...
if __name__ == "__main__":
    ...
    # ----------------- For PO dataset ---------------------
    # np.save('../embedding/PO_train_embedding.npy', x_train_encoding)
    # np.save('../embedding/PO_test_embedding.npy', x_test_encoding)
    # ----------------- For C dataset ---------------------
    # np.save('../embedding/C_train_embedding.npy', x_train_encoding)
    # np.save('../embedding/C_test_embedding.npy', x_test_encoding)
    # ------------------------------------------------------
    # ----------------- For C2 dataset ---------------------
    np.save('../embedding/C2_train_embedding.npy', x_train_encoding)
    np.save('../embedding/C2_test_embedding.npy', x_test_encoding)
    print('end')